User.class_eval do
  ...
  def update_with_password(params = {})
    ...
    self.ship_address.delete if params[:delete_ship_address] == 'true' && !self.ship_address.nil?
    self.bill_address.delete if params[:delete_bill_address] == 'true' && !self.bill_address.nil?
  end
